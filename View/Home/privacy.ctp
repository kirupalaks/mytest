	...
	<div class="top-ribbon" style="margin-top:60px">
		<div class="container">
			<div class="row-fluid">
				<div class="span4 top-ribbon-head" style="margin-top:20px;">Privacy Policy</div>
				<div class="span8"></div>
			</div>
		</div>
	</div>
...
<ol>
	...
	<li> Provide customer support and the services you request; Ascertain how many people visit our website, of what kind and what areas they visit,on our website;</li>
	...
	<li> Protect the rights, property or safety of AGET and/or its Directors, employees and the general public at large;</li>
...
<p>Your information shall be disclosed to our employees/service providers who provide services to us vis-a-vis our website and the services/products therein. These service providers/employees will have access to the information provided by you in order to perform their functions/services efficiently.</p>
...
<p>
<strong>Resume Information</strong><br>
...
The website contains links to other sites that are not owned or controlled by AGET. Please be aware that we, AGET and/or the website, are not responsible for the privacy practices of such other sites.</p>

<p>
We encourage you to be aware when you leave our site and to read the privacy statements of each and every Web site that collects personally identifiable information.</p>
<p>
...
If we decide to change our privacy policy, we will post those changes to this privacy statement and such other places we deem appropriate so that you are updated about the manner we collect information, what information we collect, how we use it and under what circumstances, if any, we disclose it.</p>
<p>We reserve the right to modify this privacy statement at any time, so please review it frequently at ahaguru.com</p>

<p>
<strong>Contact Us</strong><br>
If you have any questions or suggestions regarding our privacy policy, please contact us at: <a href="mailto:learn@ahaguru.com">learn@ahaguru.com </a>
</p>
