<?php
$hash = "e8ea4cd44d1e3bf222058592fcc464d7"."|".$_POST['account_id']."|".$_POST['amount']."|".$_POST['reference_no']."|".$_POST['return_url']."|".$_POST['mode'];

$secure_hash = md5($hash);


?>
<form  method="post" action="/student/pay" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">
