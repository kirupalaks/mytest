...
<form  method="post" action="/pay/secure" name="frmTransaction" id="frmTransaction" onSubmit="return validate()">
  ...
  <tr>
    ...
    <td align="left"><input name="return_url" type="text" size="60" value="http://ahaguru.com/response.php?DR={DR}" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><select name="country">
      ...
      <option value="ALA">\C5land Islands</option>
      ...
      <option value="BLM">Saint Barth\E9lemy</option>
      ...
      <option value="CIV">C\F4te d`Ivoire</option>
      ...
      <option value="REU">R\E9union</option>
